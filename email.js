...
email_data = JSON.parse(fs.readFileSync('./email/emails/' + process.argv[2]));
var data_path = path.parse(process.argv[2]);
var assets_path = `assets/${data_path.dir}/${data_path.name}/`;
